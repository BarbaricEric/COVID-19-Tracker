...
function NewsList2(props) {
  return ("h3", null, props.newsTitle)
}  
function NewsList3(props) {
  e("p", {class: "price"}, "Source: ", props.newsSource, ", Published on ", props.newsDate),
}
function NewsList4(props) {
  e("a", {href: "props.newsLink", class: "btn"}, props.newlinkTitle),
  e("div", {class: "news-box news-box-b"},
  e("img", {src: "img/coronavirus-19-mobile.jpg",alt: "COVID-19 News Image"}))  
}

class NewsApp1 extends React.Component {
 render() {
    return e("div", null, e(NewsList1, {newsType: "Media News"}),
         e(NewsList2, {newsTitle: "How Virginia Improved Vaccination Rates Among Latinx Residents"}),
         e(NewsList3, {newsSource: "NPR"}, {newsDate: "June 6, 2021"}), 
         e(NewsList4, {newsLink: "https://www.npr.org/2021/06/06/1003713835/how-virginia-improved-vaccination-rates-among-latinx-residents"}, {newlinkTitle: "Link to Article"}),
