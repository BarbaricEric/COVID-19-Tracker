...
//NY Count from New York Times
  d3.csv("./nytimes_covid_19_data/nytimes_daily_reports/12-14-2020.csv").then(function(data) {
   console.log(data);
   ...
   dcCaseDeath.textContent = data[].deaths;
   dcCaseRecent.textContent = data[].date;
   flCaseConfirm.textContent = data[9].cases;
   flCaseDeath.textContent = data[].deaths;
   flCaseRecent.textContent = data[].date;
   gaCaseConfirm.textContent = data[10].cases;
   gaCaseDeath.textContent = data[].deaths;
   gaCaseRecent.textContent = data[].date;
   guCaseConfirm.textContent = data[11].cases;
   guCaseDeath.textContent = data[].deaths;
   guCaseRecent.textContent = data[].date;
   hiCaseConfirm.textContent = data[12].cases;
   hiCaseDeath.textContent = data[].deaths;
   hiCaseRecent.textContent = data[].date;
   idCaseConfirm.textContent = data[13].cases;
   idCaseDeath.textContent = data[].deaths;
   idCaseRecent.textContent = data[].date;
   ilCaseConfirm.textContent = data[14].cases;
   ilCaseDeath.textContent = data[].deaths;
   ilCaseRecent.textContent = data[].date;
   inCaseConfirm.textContent = data[15].cases;
   inCaseDeath.textContent = data[].deaths;
   inCaseRecent.textContent = data[].date;
   iaCaseConfirm.textContent = data[16].cases;
   iaCaseDeath.textContent = data[].deaths;
   iaCaseRecent.textContent = data[].date;
   ksCaseConfirm.textContent = data[17].cases;
   ksCaseDeath.textContent = data[].deaths;
   ksCaseRecent.textContent = data[].date;
   kyCaseConfirm.textContent = data[18].cases;
   kyCaseDeath.textContent = data[].deaths;
   kyCaseRecent.textContent = data[].date;
   laCaseConfirm.textContent = data[19].cases;
   laCaseDeath.textContent = data[].deaths;
   laCaseRecent.textContent = data[].date;
   meCaseConfirm.textContent = data[20].cases;
   meCaseDeath.textContent = data[].deaths;
   meCaseRecent.textContent = data[].date;
   mdCaseConfirm.textContent = data[21].cases;
   mdCaseDeath.textContent = data[].deaths;
   mdCaseRecent.textContent = data[].date;
   maCaseConfirm.textContent = data[22].cases;
   maCaseDeath.textContent = data[].deaths;
   maCaseRecent.textContent = data[].date;
   miCaseConfirm.textContent = data[23].cases;
   miCaseDeath.textContent = data[].deaths;
   miCaseRecent.textContent = data[].date;
   mnCaseConfirm.textContent = data[24].cases;
   mnCaseDeath.textContent = data[].deaths;
   mnCaseRecent.textContent = data[].date;
   msCaseConfirm.textContent = data[25].cases;
   msCaseDeath.textContent = data[].deaths;
   msCaseRecent.textContent = data[].date;
   moCaseConfirm.textContent = data[26].cases;
   moCaseDeath.textContent = data[].deaths;
   moCaseRecent.textContent = data[].date;
   mtCaseConfirm.textContent = data[27].cases;
   mtCaseDeath.textContent = data[].deaths;
   mtCaseRecent.textContent = data[].date;
   neCaseConfirm.textContent = data[28].cases;
   neCaseDeath.textContent = data[].deaths;
   neCaseRecent.textContent = data[].date;
   nvCaseConfirm.textContent = data[29].cases;
   nvCaseDeath.textContent = data[30].deaths;
   nvCaseRecent.textContent = data[].date;
   nhCaseConfirm.textContent = data[31].cases;
   nhCaseDeath.textContent = data[].deaths;
   nhCaseRecent.textContent = data[].date;
   nmCaseConfirm.textContent = data[32].cases;
   nmCaseDeath.textContent = data[].deaths;
   nmCaseRecent.textContent = data[].date;
   ny
   ncCaseConfirm.textContent = data[34].cases;
   ncCaseDeath.textContent = data[].deaths;
   ncCaseRecent.textContent = data[].date;
   ndCaseConfirm.textContent = data[35].cases;
   ndCaseDeath.textContent = data[].deaths;
   ndCaseRecent.textContent = data[].date;
   mpCaseConfirm.textContent = data[36].cases;
   mpCaseDeath.textContent = data[].deaths;
   mpCaseRecent.textContent = data[].date;
   ohCaseConfirm.textContent = data[37].cases;
   ohCaseDeath.textContent = data[].deaths;
   ohCaseRecent.textContent = data[].date;
   okCaseConfirm.textContent = data[38].cases;
   okCaseDeath.textContent = data[].deaths;
   okCaseRecent.textContent = data[].date;
   orCaseConfirm.textContent = data[39].cases;
   orCaseDeath.textContent = data[].deaths;
   orCaseRecent.textContent = data[].date;
   paCaseConfirm.textContent = data[30].cases;
   paCaseDeath.textContent = data[].deaths;
   paCaseRecent.textContent = data[].date;
   prCaseConfirm.textContent = data[41].cases;
   prCaseDeath.textContent = data[].deaths;
   prCaseRecent.textContent = data[].date;
   riCaseConfirm.textContent = data[42].cases;
   riCaseDeath.textContent = data[].deaths;
   riCaseRecent.textContent = data[].date;
   scCaseConfirm.textContent = data[43].cases;
   scCaseDeath.textContent = data[].deaths;
   scCaseRecent.textContent = data[].date;
   sdCaseConfirm.textContent = data[44].cases;
   sdCaseDeath.textContent = data[].deaths;
   sdCaseRecent.textContent = data[].date;
   tnCaseConfirm.textContent = data[45].cases;
   tnCaseDeath.textContent = data[].deaths;
   tnCaseRecent.textContent = data[].date;
   txCaseConfirm.textContent = data[46].cases;
   txCaseDeath.textContent = data[].deaths;
   txCaseRecent.textContent = data[].date;
   viCaseConfirm.textContent = data[47].cases;
   viCaseDeath.textContent = data[].deaths;
   viCaseRecent.textContent = data[].date;
   utCaseConfirm.textContent = data[48].cases;
   utCaseDeath.textContent = data[].deaths;
   utCaseRecent.textContent = data[].date;
   vtCaseConfirm.textContent = data[49].cases;
   vtCaseDeath.textContent = data[].deaths;
   vtCaseRecent.textContent = data[].date;
   vaCaseConfirm.textContent = data[50].cases;
   vaCaseDeath.textContent = data[].deaths;
   vaCaseRecent.textContent = data[].date;
   waCaseConfirm.textContent = data[51].cases;
   waCaseDeath.textContent = data[].deaths;
   waCaseRecent.textContent = data[].date;
   wvCaseConfirm.textContent = data[52].cases;
   wvCaseDeath.textContent = data[].deaths;
   wvCaseRecent.textContent = data[].date;
   wiCaseConfirm.textContent = data[53].cases;
   wiCaseDeath.textContent = data[].deaths;
   wiCaseRecent.textContent = data[].date;
   wyCaseConfirm.textContent = data[54].cases;
   wyCaseDeath.textContent = data[].deaths;
   wyCaseRecent.textContent = data[].date;
   */  
