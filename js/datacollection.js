...
//US Count from covid-api.com      
   fetch('https://covid-api.com/api/reports?date=2021-04-12&iso=USA', {
  method: 'GET',
  mode: 'cors', // no-cors, *cors, same-origin
  cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
  credentials: 'same-origin', // include, *same-origin, omit
  ...
  .then(data => {
   ...
   alCaseConfirm.textContent = addCommas(data.data[52].confirmed);
   alCaseDeath.textContent = addCommas(data.data[52].deaths); 
   alCaseRecent.textContent = data.data[52].date;
   akCaseConfirm.textContent = addCommas(data.data[39].confirmed);
   akCaseDeath.textContent = addCommas(data.data[39].deaths); 
   ...
   azCaseConfirm.textContent = addCommas(data.data[3].confirmed);
   azCaseDeath.textContent = addCommas(data.data[3].deaths); 
   azCaseRecent.textContent = data.data[3].date;
   arCaseConfirm.textContent = addCommas(data.data[40].confirmed);
   arCaseDeath.textContent = addCommas(data.data[40].deaths); 
   arCaseRecent.textContent = data.data[40].date;
   caCaseConfirm.textContent = addCommas(data.data[2].confirmed);
   caCaseDeath.textContent = addCommas(data.data[2].deaths); 
   caCaseRecent.textContent = data.data[2].date;
   coCaseConfirm.textContent = addCommas(data.data[9].confirmed);
   coCaseDeath.textContent = addCommas(data.data[9].deaths); 
   coCaseRecent.textContent = data.data[9].date;
   ctCaseConfirm.textContent = addCommas(data.data[31].confirmed);
   ctCaseDeath.textContent = addCommas(data.data[31].deaths); 
   ctCaseRecent.textContent = data.data[31].date;
   deCaseConfirm.textContent = addCommas(data.data[41].confirmed);
   deCaseDeath.textContent = addCommas(data.data[41].deaths); 
   deCaseRecent.textContent = data.data[41].date;
   dcCaseConfirm.textContent = addCommas(data.data[23].confirmed);
   dcCaseDeath.textContent = addCommas(data.data[23].deaths); 
   ...
   gaCaseConfirm.textContent = addCommas(data.data[8].confirmed);
   gaCaseDeath.textContent = addCommas(data.data[8].deaths);
   gaCaseRecent.textContent = data.data[8].date;
   guCaseConfirm.textContent = addCommas(data.data[54].confirmed);
   guCaseDeath.textContent = addCommas(data.data[54].deaths);
   guCaseRecent.textContent = data.data[54].date;
   hiCaseConfirm.textContent = addCommas(data.data[32].confirmed);
   hiCaseDeath.textContent = addCommas(data.data[32].deaths);
   hiCaseRecent.textContent = data.data[32].date;
   idCaseConfirm.textContent = addCommas(data.data[42].confirmed);
   idCaseDeath.textContent = addCommas(data.data[42].deaths);
   idCaseRecent.textContent = data.data[42].date;
   ilCaseConfirm.textContent = addCommas(data.data[1].confirmed);
   ilCaseDeath.textContent = addCommas(data.data[1].deaths);
   ilCaseRecent.textContent = data.data[1].date;
   inCaseConfirm.textContent = addCommas(data.data[21].confirmed);
   inCaseDeath.textContent = addCommas(data.data[21].deaths);
   inCaseRecent.textContent = data.data[21].date;
   iaCaseConfirm.textContent = addCommas(data.data[15].confirmed);
   iaCaseDeath.textContent = addCommas(data.data[15].deaths);
   iaCaseRecent.textContent = data.data[15].date;
   ksCaseConfirm.textContent = addCommas(data.data[35].confirmed);
   ksCaseDeath.textContent = addCommas(data.data[35].deaths);
   ksCaseRecent.textContent = data.data[35].date;
   kyCaseConfirm.textContent = addCommas(data.data[22].confirmed);
   kyCaseDeath.textContent = addCommas(data.data[22].deaths);
   kyCaseRecent.textContent = data.data[22].date;
   laCaseConfirm.textContent = addCommas(data.data[36].confirmed);
   laCaseDeath.textContent = addCommas(data.data[36].deaths);
   laCaseRecent.textContent = data.data[36].date;
   meCaseConfirm.textContent = addCommas(data.data[43].confirmed);
   meCaseDeath.textContent = addCommas(data.data[43].deaths);
   meCaseRecent.textContent = data.data[43].date;
   mdCaseConfirm.textContent = addCommas(data.data[16].confirmed);
   mdCaseDeath.textContent = addCommas(data.data[16].deaths);
   mdCaseRecent.textContent = data.data[16].date;
   maCaseConfirm.textContent = addCommas(data.data[5].confirmed);
   maCaseDeath.textContent = addCommas(data.data[5].deaths);
   maCaseRecent.textContent = data.data[5].date;
   miCaseConfirm.textContent = addCommas(data.data[44].confirmed);
   miCaseDeath.textContent = addCommas(data.data[44].deaths);
   ...
   msCaseConfirm.textContent = addCommas(data.data[45].confirmed);
   msCaseDeath.textContent = addCommas(data.data[45].deaths);
   msCaseRecent.textContent = data.data[45].date;
   moCaseConfirm.textContent = addCommas(data.data[37].confirmed);
   moCaseDeath.textContent = addCommas(data.data[37].deaths);
   moCaseRecent.textContent = data.data[37].date;
   mtCaseConfirm.textContent = addCommas(data.data[46].confirmed);
   mtCaseDeath.textContent = addCommas(data.data[46].deaths);
   mtCaseRecent.textContent = data.data[46].date;
   neCaseConfirm.textContent = addCommas(data.data[27].confirmed);
   neCaseDeath.textContent = addCommas(data.data[27].deaths);
   neCaseRecent.textContent = data.data[27].date;
   nvCaseConfirm.textContent = addCommas(data.data[24].confirmed);
   nvCaseDeath.textContent = addCommas(data.data[24].deaths);
   nvCaseRecent.textContent = data.data[24].date;
   nhCaseConfirm.textContent = addCommas(data.data[25].confirmed);
   nhCaseDeath.textContent = addCommas(data.data[25].deaths);
   nhCaseRecent.textContent = data.data[25].date;
   njCaseConfirm.textContent = addCommas(data.data[11].confirmed);
   njCaseDeath.textContent = addCommas(data.data[11].deaths);
   njCaseRecent.textContent = data.data[11].date;
   nmCaseConfirm.textContent = addCommas(data.data[47].confirmed);
   nmCaseDeath.textContent = addCommas(data.data[47].deaths);
   nmCaseRecent.textContent = data.data[47].date;
   nyCaseConfirm.textContent = addCommas(data.data[4].confirmed);
   nyCaseDeath.textContent = addCommas(data.data[4].deaths);
   ...
   mpCaseDeath.textContent = addCommas(data.data[56].deaths);
   mpCaseRecent.textContent = data.data[56].date;
   ohCaseConfirm.textContent = addCommas(data.data[28].confirmed);
   ohCaseDeath.textContent = addCommas(data.data[28].deaths);
   ohCaseRecent.textContent = data.data[28].date;
   okCaseConfirm.textContent = addCommas(data.data[33].confirmed);
   okCaseDeath.textContent = addCommas(data.data[33].deaths);
   okCaseRecent.textContent = data.data[33].date;
   orCaseConfirm.textContent = addCommas(data.data[12].confirmed);
   orCaseDeath.textContent = addCommas(data.data[12].deaths);
   orCaseRecent.textContent = data.data[12].date;
   paCaseConfirm.textContent = addCommas(data.data[14].confirmed);
   paCaseDeath.textContent = addCommas(data.data[14].deaths);
   paCaseRecent.textContent = data.data[14].date;
   prCaseConfirm.textContent = addCommas(data.data[53].confirmed);
   prCaseDeath.textContent = addCommas(data.data[53].deaths);
   prCaseRecent.textContent = data.data[53].date;
   riCaseConfirm.textContent = addCommas(data.data[29].confirmed);
   riCaseDeath.textContent = addCommas(data.data[29].deaths);
   riCaseRecent.textContent = data.data[29].date;
   scCaseConfirm.textContent = addCommas(data.data[18].confirmed);
   scCaseDeath.textContent = addCommas(data.data[18].deaths);
   scCaseRecent.textContent = data.data[18].date;
   sdCaseConfirm.textContent = addCommas(data.data[49].confirmed);
   sdCaseDeath.textContent = addCommas(data.data[49].deaths);
   sdCaseRecent.textContent = data.data[49].date;
   tnCaseConfirm.textContent = addCommas(data.data[19].confirmed);
   tnCaseDeath.textContent = addCommas(data.data[19].deaths);
   tnCaseRecent.textContent = data.data[19].date;
   txCaseConfirm.textContent = addCommas(data.data[13].confirmed);
   txCaseDeath.textContent = addCommas(data.data[13].deaths);
   txCaseRecent.textContent = data.data[13].date;
   viCaseConfirm.textContent = addCommas(data.data[55].confirmed);
   viCaseDeath.textContent = addCommas(data.data[55].deaths);
   viCaseRecent.textContent = data.data[55].date;
   utCaseConfirm.textContent = addCommas(data.data[34].confirmed);
   utCaseDeath.textContent = addCommas(data.data[34].deaths);
   utCaseRecent.textContent = data.data[34].date;
   vtCaseConfirm.textContent = addCommas(data.data[38].confirmed);
   vtCaseDeath.textContent = addCommas(data.data[38].deaths);
   vtCaseRecent.textContent = data.data[38].date;
   vaCaseConfirm.textContent = addCommas(data.data[20].confirmed);
   vaCaseDeath.textContent = addCommas(data.data[20].deaths);
   vaCaseRecent.textContent = data.data[20].date;
   waCaseConfirm.textContent = addCommas(data.data[0].confirmed);
   waCaseDeath.textContent = addCommas(data.data[0].deaths);
   waCaseRecent.textContent = data.data[0].date;
   wvCaseConfirm.textContent = addCommas(data.data[50].confirmed);
   wvCaseDeath.textContent = addCommas(data.data[50].deaths);
   wvCaseRecent.textContent = data.data[50].date;
   wiCaseConfirm.textContent = addCommas(data.data[30].confirmed);
   wiCaseDeath.textContent = addCommas(data.data[30].deaths);
   wiCaseRecent.textContent = data.data[30].date;
   wyCaseConfirm.textContent = addCommas(data.data[51].confirmed);
   wyCaseDeath.textContent = addCommas(data.data[51].deaths);
...
//US Count from New York Times
  d3.csv("./nytimes_covid_19_data/nytimes_us_total.csv").then(function(data) {
   ...
   usCaseConfirm.textContent = addCommas(data[447].cases);
   usCaseDeath.textContent = addCommas(data[447].deaths); 
   usCaseRecent.textContent = data[447].date;
  });

//NY Count from New York Times
  d3.csv("./nytimes_covid_19_data/nytimes_daily_reports/04-12-2021.csv").then(function(data) {
   console.log(data);
