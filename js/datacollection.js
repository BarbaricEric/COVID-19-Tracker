...
//US Count from covid-api.com      
   fetch('https://covid-api.com/api/reports?date=2021-11-07&iso=USA', {
  method: 'GET',
  mode: 'cors', // no-cors, *cors, same-origin
  cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
  credentials: 'same-origin', // include, *same-origin, omit
...
d3v6.csv("./nytimes_covid_19_data/nytimes_daily_reports/daily.csv").then(function(data) {
   ...
   azCaseConfirm.textContent = addCommas(data[3].cases);
   azCaseDeath.textContent = addCommas(data[3].deaths);
   azCaseRecent.textContent = data[3].date;   
   asCaseConfirm.textContent = addCommas(data[2].cases);
   asCaseDeath.textContent = addCommas(data[2].deaths);
   asCaseRecent.textContent = data[2].date;  
   arCaseConfirm.textContent = addCommas(data[4].cases);
   arCaseDeath.textContent = addCommas(data[4].deaths);
   arCaseRecent.textContent = data[4].date;   
   caCaseConfirm.textContent = addCommas(data[5].cases);
   caCaseDeath.textContent = addCommas(data[5].deaths);
   caCaseRecent.textContent = data[5].date;   
   coCaseConfirm.textContent = addCommas(data[6].cases);
   coCaseDeath.textContent = addCommas(data[6].deaths);
   coCaseRecent.textContent = data[6].date;   
   ctCaseConfirm.textContent = addCommas(data[7].cases);
   ctCaseDeath.textContent = addCommas(data[7].deaths);
   ctCaseRecent.textContent = data[7].date;   
   deCaseConfirm.textContent = addCommas(data[8].cases);
   deCaseDeath.textContent = addCommas(data[8].deaths);
   deCaseRecent.textContent = data[8].date; 
   dcCaseConfirm.textContent = addCommas(data[9].cases);
   dcCaseDeath.textContent = addCommas(data[9].deaths);
   dcCaseRecent.textContent = data[9].date;
   flCaseConfirm.textContent = addCommas(data[10].cases);
   flCaseDeath.textContent = addCommas(data[10].deaths);
   flCaseRecent.textContent = data[10].date;
   gaCaseConfirm.textContent = addCommas(data[11].cases);
   gaCaseDeath.textContent = addCommas(data[11].deaths);
   gaCaseRecent.textContent = data[11].date;
   guCaseConfirm.textContent = addCommas(data[12].cases);
   guCaseDeath.textContent = addCommas(data[12].deaths);
   guCaseRecent.textContent = data[12].date;
   hiCaseConfirm.textContent = addCommas(data[13].cases);
   hiCaseDeath.textContent = addCommas(data[13].deaths);
   hiCaseRecent.textContent = data[13].date;
   idCaseConfirm.textContent = addCommas(data[14].cases);
   idCaseDeath.textContent = addCommas(data[14].deaths);
   idCaseRecent.textContent = data[14].date;
   ilCaseConfirm.textContent = addCommas(data[15].cases);
   ilCaseDeath.textContent = addCommas(data[15].deaths);
   ilCaseRecent.textContent = data[15].date;
   inCaseConfirm.textContent = addCommas(data[16].cases);
   inCaseDeath.textContent = addCommas(data[16].deaths);
   inCaseRecent.textContent = data[16].date;
   iaCaseConfirm.textContent = addCommas(data[17].cases);
   iaCaseDeath.textContent = addCommas(data[17].deaths);
   iaCaseRecent.textContent = data[17].date;
   ksCaseConfirm.textContent = addCommas(data[18].cases);
   ksCaseDeath.textContent = addCommas(data[18].deaths);
   ksCaseRecent.textContent = data[18].date;
   kyCaseConfirm.textContent = addCommas(data[19].cases);
   kyCaseDeath.textContent = addCommas(data[19].deaths);
   kyCaseRecent.textContent = data[19].date;
   laCaseConfirm.textContent = addCommas(data[20].cases);
   laCaseDeath.textContent = addCommas(data[20].deaths);
   laCaseRecent.textContent = data[20].date;
   meCaseConfirm.textContent = addCommas(data[21].cases);
   meCaseDeath.textContent = addCommas(data[21].deaths);
   meCaseRecent.textContent = data[21].date;
   mdCaseConfirm.textContent = addCommas(data[22].cases);
   mdCaseDeath.textContent = addCommas(data[22].deaths);
   mdCaseRecent.textContent = data[22].date;
   maCaseConfirm.textContent = addCommas(data[23].cases);
   maCaseDeath.textContent = addCommas(data[23].deaths);
   maCaseRecent.textContent = data[23].date;
   miCaseConfirm.textContent = addCommas(data[24].cases);
   miCaseDeath.textContent = addCommas(data[24].deaths);
   miCaseRecent.textContent = data[24].date;
   mnCaseConfirm.textContent = addCommas(data[25].cases);
   mnCaseDeath.textContent = addCommas(data[25].deaths);
   mnCaseRecent.textContent = data[25].date;
   msCaseConfirm.textContent = addCommas(data[26].cases);
   msCaseDeath.textContent = addCommas(data[26].deaths);
   msCaseRecent.textContent = data[26].date;
   moCaseConfirm.textContent = addCommas(data[27].cases);
   moCaseDeath.textContent = addCommas(data[27].deaths);
   moCaseRecent.textContent = data[27].date;
   mtCaseConfirm.textContent = addCommas(data[28].cases);
   mtCaseDeath.textContent = addCommas(data[28].deaths);
   mtCaseRecent.textContent = data[28].date;
   neCaseConfirm.textContent = addCommas(data[29].cases);
   neCaseDeath.textContent = addCommas(data[29].deaths);
   neCaseRecent.textContent = data[29].date;
   nvCaseConfirm.textContent = addCommas(data[30].cases);
   nvCaseDeath.textContent = addCommas(data[30].deaths);
   nvCaseRecent.textContent = data[30].date;
   nhCaseConfirm.textContent = addCommas(data[31].cases);
   nhCaseDeath.textContent = addCommas(data[31].deaths);
   nhCaseRecent.textContent = data[31].date;
   njCaseConfirm.textContent = addCommas(data[32].cases);
   njCaseDeath.textContent = addCommas(data[32].deaths);
   njCaseRecent.textContent = data[32].date;     
   nmCaseConfirm.textContent = addCommas(data[33].cases);
   nmCaseDeath.textContent = addCommas(data[33].deaths);
   nmCaseRecent.textContent = data[33].date;
   nyCaseConfirm.textContent = addCommas(data[34].cases);
   nyCaseDeath.textContent = addCommas(data[34].deaths);
   nyCaseRecent.textContent = data[34].date;
   ncCaseConfirm.textContent = addCommas(data[35].cases);
   ncCaseDeath.textContent = addCommas(data[35].deaths);
   ncCaseRecent.textContent = data[35].date;
   ndCaseConfirm.textContent = addCommas(data[36].cases);
   ndCaseDeath.textContent = addCommas(data[36].deaths);
   ndCaseRecent.textContent = data[36].date;
   mpCaseConfirm.textContent = addCommas(data[37].cases);
   mpCaseDeath.textContent = addCommas(data[37].deaths);
   mpCaseRecent.textContent = data[37].date;
   ohCaseConfirm.textContent = addCommas(data[38].cases);
   ohCaseDeath.textContent = addCommas(data[38].deaths);
   ohCaseRecent.textContent = data[38].date;
   okCaseConfirm.textContent = addCommas(data[39].cases);
   okCaseDeath.textContent = addCommas(data[39].deaths);
   okCaseRecent.textContent = data[39].date;
   orCaseConfirm.textContent = addCommas(data[40].cases);
   orCaseDeath.textContent = addCommas(data[40].deaths);
   orCaseRecent.textContent = data[40].date;
   paCaseConfirm.textContent = addCommas(data[41].cases);
   paCaseDeath.textContent = addCommas(data[41].deaths);
   paCaseRecent.textContent = data[41].date;
   prCaseConfirm.textContent = addCommas(data[42].cases);
   prCaseDeath.textContent = addCommas(data[42].deaths);
   prCaseRecent.textContent = data[42].date;
   riCaseConfirm.textContent = addCommas(data[43].cases);
   riCaseDeath.textContent = addCommas(data[43].deaths);
   riCaseRecent.textContent = data[43].date;
   scCaseConfirm.textContent = addCommas(data[44].cases);
   scCaseDeath.textContent = addCommas(data[44].deaths);
   scCaseRecent.textContent = data[44].date;
   sdCaseConfirm.textContent = addCommas(data[45].cases);
   sdCaseDeath.textContent = addCommas(data[45].deaths);
   sdCaseRecent.textContent = data[45].date;
   tnCaseConfirm.textContent = addCommas(data[46].cases);
   tnCaseDeath.textContent = addCommas(data[46].deaths);
   tnCaseRecent.textContent = data[46].date;
   txCaseConfirm.textContent = addCommas(data[47].cases);
   txCaseDeath.textContent = addCommas(data[47].deaths);
   txCaseRecent.textContent = data[47].date;
   viCaseConfirm.textContent = addCommas(data[48].cases);
   viCaseDeath.textContent = addCommas(data[48].deaths);
   viCaseRecent.textContent = data[48].date;
   utCaseConfirm.textContent = addCommas(data[49].cases);
   utCaseDeath.textContent = addCommas(data[49].deaths);
   utCaseRecent.textContent = data[49].date;
   vtCaseConfirm.textContent = addCommas(data[50].cases);
   vtCaseDeath.textContent = addCommas(data[50].deaths);
   vtCaseRecent.textContent = data[50].date;
   vaCaseConfirm.textContent = addCommas(data[51].cases);
   vaCaseDeath.textContent = addCommas(data[51].deaths);
   vaCaseRecent.textContent = data[51].date;
   waCaseConfirm.textContent = addCommas(data[52].cases);
   waCaseDeath.textContent = addCommas(data[52].deaths);
   waCaseRecent.textContent = data[52].date;
   wvCaseConfirm.textContent = addCommas(data[53].cases);
   wvCaseDeath.textContent = addCommas(data[53].deaths);
   wvCaseRecent.textContent = data[53].date;
   wiCaseConfirm.textContent = addCommas(data[54].cases);
   wiCaseDeath.textContent = addCommas(data[54].deaths);
   wiCaseRecent.textContent = data[54].date;
   wyCaseConfirm.textContent = addCommas(data[55].cases);
   wyCaseDeath.textContent = addCommas(data[55].deaths);
   wyCaseRecent.textContent = data[55].date;    
  });
